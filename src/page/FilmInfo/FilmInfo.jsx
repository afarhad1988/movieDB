			...
			<div className='filmsInfo'>
                ...
                <div className="row">
                 ...
                 <div className="col-10">
					...
					<div className="col-2">
						<h3 className="facts-title">Факты</h3>
						<p className='filmsInfo-facts'><b>Исходное название</b></p>
						<span >{filmsInfo.original_title}</span>
						<p className='filmsInfo-facts'><b>Статус</b></p>
						<span >{filmsInfo.status === "Released" ? "Выпущено" : '-'}</span>
						<p className='filmsInfo-facts'><b>Бюджет</b></p>
						{filmsInfo.budget ? <span>${filmsInfo.budget.toLocaleString()}</span> : "－"}
						<p className='filmsInfo-facts'><b>Сборы </b></p>
						{filmsInfo.revenue ? <span>${filmsInfo.revenue.toLocaleString()}</span> : "－"}
						<p className='filmsInfo-facts'><b>Оригинальный язык</b></p>
